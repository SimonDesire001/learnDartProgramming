...
//seperate method to print the features of each television
//method to print the features of all the televisions
...
class Television {
  ...
  //method to get size per price ratio
  double getSizePerPriceRatio() {
    return size/price;
  }
...
//create objects of  television types
 ...
 //call detail method
  ...
  int x = 1;
  for (Television tel in televisions){
